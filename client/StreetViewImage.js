...
class StreetViewImage extends React.Component {
  ...
  render() {
    if (!this.props.latitude || !this.props.longitude) return <div></div>;
    return <div>
        <img src={'https://maps.googleapis.com/maps/api/streetview?size=600x300&location=' + this.props.latitude + ',' + this.props.longitude + '&heading=' + this.state.degree + '&key=' + config.STREET_VIEW} />
